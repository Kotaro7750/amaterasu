...
SRC = main.c fb.c graphic.c font.c x86_64.c kbc.c interrupt.c pic.c handler.c paging.c physicalMemory.c acpi.c util.c hpet.c scheduler.c syscall.c process.c ata.c fat.c
OBJ = $(SRC:%.c=%.o)
